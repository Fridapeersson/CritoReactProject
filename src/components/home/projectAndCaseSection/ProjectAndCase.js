      ...
      <section className="projectAndCaseSection section">
        <div className="container">
          ...
          <div className="projectAndCases">
            {
              projectBoxes.map((articleBox, index) => (
                <ProjectBoxes key={index} url={articleBox.url} imgSrc={articleBox.imgSrc} imgAltText={articleBox.imgAltText} title={articleBox.title} />
              ))
            }
          </div>
